(() => {
  ...
  const BUILD = "v5.1.1-doll-bootstrap-first";
  ...
  const BOOT = {
    ...
    assetParts: [
      "./doll-assets-v511-part1.js",
      "./doll-assets-v511-part2.js",
      "./doll-assets-v511-part3.js",
      "./doll-assets-v511-part4.js",
      "./doll-assets-v511-part5.js",
    ],
    version: "5.1.1-bootstrap-first",
  };
  ...
  const Assets = {
    ...
    rig: {
      // Metadata layer: fixes per-animation direction/phase without global mirror hacks.
      // srcFlipX fixes the source sheet direction for only that animation.
      // frameReverse fixes leg/phase direction without changing facing.
      idle:   { srcFlipX: true,  frameReverse: false, y: 0 },
      walk:   { srcFlipX: false, frameReverse: true,  y: 0 },
